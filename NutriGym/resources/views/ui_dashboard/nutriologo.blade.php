...
<div class="bg-gray-100 w-full">
    <div class="header my-3 h-auto min-h-[3rem] px-4 sm:px-6 lg:px-10 flex items-center justify-between">
        <h1 class="font-medium text-xl sm:text-2xl">Clientes</h1>
    </div>
</div>
    ...
    <div class="w-full xl:w-1/3">
        <div class="neumorphic p-4 md:p-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[300px] text-xs sm:text-sm">
                    <thead>
                        <tr class="border-b-2 border-gray-200">
                            <th class="text-left p-3 md:p-4 font-semibold text-gray-700 text-xs sm:text-sm md:text-base whitespace-nowrap">ID</th>
                            <th class="text-left p-3 md:p-4 font-semibold text-gray-700 text-xs sm:text-sm md:text-base">Nombre</th>
                            <th class="text-left p-3 md:p-4 font-semibold text-gray-700 text-xs sm:text-sm md:text-base whitespace-nowrap">Rol</th>
                        </tr>
                    </thead>
                    <tbody id="tablaUsuarios">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition duration-200 cursor-pointer"
                            ...
                            <td class="p-3 md:p-4 text-gray-600 text-xs sm:text-sm md:text-base whitespace-nowrap">{{ $usuario->id }}</td>
                            <td class="p-3 md:p-4 text-gray-800 font-medium text-xs sm:text-sm md:text-base">{{ $usuario->nombre }}</td>
                            <td class="p-3 md:p-4">
                                <span class="px-2 py-1 rounded-full text-[10px] sm:text-xs md:text-sm font-medium bg-gray-100 text-gray-800 whitespace-nowrap">
...
<script>
        ...
        document.getElementById('detallesUsuario').innerHTML = `
            <div class="bg-white p-4 sm:p-6 rounded-lg">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-800">Detalles del Usuario</h3>
                    <button onclick="limpiarSeleccion()" class="btn-neu bg-gray-500 hover:bg-gray-600 text-white text-xs sm:text-sm px-4 py-2 w-full sm:w-auto">
                        Cerrar
                    </button>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">ID</label>
                        <p class="text-base sm:text-lg text-gray-800 break-all">${usuario.id}</p>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Nombre</label>
                        <p class="text-base sm:text-lg text-gray-800 break-words">${usuario.nombre}</p>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Email</label>
                        <p class="text-base sm:text-lg text-gray-800 break-all">${usuario.email}</p>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Rol</label>
                        <span class="inline-block mt-1 px-3 py-1 rounded-full text-xs sm:text-sm font-medium ${
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Fecha de Nacimiento</label>
                        <p class="text-base sm:text-lg text-gray-800">${new Date(usuario.fecha_nacimiento).toLocaleDateString()}</p>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Fecha de Registro</label>
                        <p class="text-base sm:text-lg text-gray-800">${new Date(usuario.fecha_registro).toLocaleDateString()}</p>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs sm:text-sm font-medium text-gray-600">Gasto Energético (GET)</label>
                        <p class="text-base sm:text-lg text-gray-800" id="getUsuario">Calculando...</p>
                    </div>
                </div>
    ...
    function limpiarSeleccion() {
        ...
        document.getElementById('detallesUsuario').innerHTML = `
            <div id="mensajeVacio" class="text-center py-8 text-gray-500 text-sm sm:text-base">
                Selecciona un usuario para ver sus detalles
            </div>
        `;
